...
class VideoParams(BaseModel):
    ...
    # 🏷️ Channel Logo Watermark settings
    logo_path: Optional[str] = ""
    logo_position: Optional[str] = "top_right"
    logo_size: Optional[int] = 120
    logo_opacity: Optional[float] = 0.90
    ...
    # Advanced Zero-Budget Features
    enable_ken_burns: Optional[bool] = True
    enable_audio_ducking: Optional[bool] = True
    bgm_matching_mode: Optional[str] = "random"  # random, smart
    secondary_voice_name: Optional[str] = ""     # For podcast/dialogue mode
                    ...
                    "files": [
                        {
                            "name": "output013.mp3",
                            "size": 1891269,
                            "file": "/ClipGenesis/resource/songs/output013.mp3",
                        }
                    ]
                },
            },
    ...
    class Config:
        json_schema_extra = {
            "example": {
                "status": 200,
                "message": "success",
                "data": {"file": "/ClipGenesis/resource/songs/example.mp3"},
            },
        }
