#!/bin/bash
# ClipGenesis CUDA Installation Script
# Installs complete CUDA 12.x ecosystem with dual cuDNN support

echo "🚀 Installing ClipGenesis CUDA Dependencies"
echo "================================================="
...
if conda info --envs | grep -q "ClipGenesis"; then
    echo "📦 Activating existing ClipGenesis environment..."
    source activate ClipGenesis
else
    echo "❌ ClipGenesis environment not found."
